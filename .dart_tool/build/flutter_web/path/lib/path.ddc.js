define(['dart_sdk'], function(dart_sdk) {
  ...
  const name = dart.privateName(posix, "PosixStyle.name");
  const separator = dart.privateName(posix, "PosixStyle.separator");
  const separators = dart.privateName(posix, "PosixStyle.separators");
  const separatorPattern = dart.privateName(posix, "PosixStyle.separatorPattern");
  const needsSeparatorPattern = dart.privateName(posix, "PosixStyle.needsSeparatorPattern");
  const rootPattern = dart.privateName(posix, "PosixStyle.rootPattern");
  const relativeRootPattern = dart.privateName(posix, "PosixStyle.relativeRootPattern");
  ...
  const style$0 = dart.privateName(parsed_path, "ParsedPath.style");
  const root$ = dart.privateName(parsed_path, "ParsedPath.root");
  const isRootRelative$ = dart.privateName(parsed_path, "ParsedPath.isRootRelative");
  const parts$ = dart.privateName(parsed_path, "ParsedPath.parts");
  const separators$ = dart.privateName(parsed_path, "ParsedPath.separators");
  ...
  let C1;
  const name$ = dart.privateName(windows, "WindowsStyle.name");
  const separator$ = dart.privateName(windows, "WindowsStyle.separator");
  const separators$0 = dart.privateName(windows, "WindowsStyle.separators");
  const separatorPattern$ = dart.privateName(windows, "WindowsStyle.separatorPattern");
  const needsSeparatorPattern$ = dart.privateName(windows, "WindowsStyle.needsSeparatorPattern");
  const rootPattern$ = dart.privateName(windows, "WindowsStyle.rootPattern");
  const relativeRootPattern$ = dart.privateName(windows, "WindowsStyle.relativeRootPattern");
  ...
  const style$1 = dart.privateName(context, "Context.style");
  ...
  const name$0 = dart.privateName(context, "_PathDirection.name");
  let C2;
  let C3;
  let C4;
  let C5;
  ...
  const name$1 = dart.privateName(context, "_PathRelation.name");
  let C6;
  let C7;
  let C8;
  let C9;
  ...
  const message$ = dart.privateName(path_exception, "PathException.message");
  ...
  const name$2 = dart.privateName(url, "UrlStyle.name");
  const separator$0 = dart.privateName(url, "UrlStyle.separator");
  const separators$1 = dart.privateName(url, "UrlStyle.separators");
  const separatorPattern$0 = dart.privateName(url, "UrlStyle.separatorPattern");
  const needsSeparatorPattern$0 = dart.privateName(url, "UrlStyle.needsSeparatorPattern");
  const rootPattern$0 = dart.privateName(url, "UrlStyle.rootPattern");
  const relativeRootPattern$0 = dart.privateName(url, "UrlStyle.relativeRootPattern");
