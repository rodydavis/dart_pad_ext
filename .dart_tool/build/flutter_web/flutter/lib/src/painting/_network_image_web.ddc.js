define(['dart_sdk', 'packages/flutter/src/foundation/_bitfield_web', 'packages/flutter/src/gestures/arena', 'packages/flutter/gestures', 'packages/vector_math/vector_math_64'], function(dart_sdk, packages__flutter__src__foundation___bitfield_web, packages__flutter__src__gestures__arena, packages__flutter__gestures, packages__vector_math__vector_math_64) {
  ...
  let Uint8List__ToFutureOfCodec = () => (Uint8List__ToFutureOfCodec = dart.constFn(dart.fnType(FutureOfCodec(), [typed_data.Uint8List], {cacheHeight: core.int, cacheWidth: core.int}, {})))();
  ...
  const color$ = dart.privateName(shape_decoration, "ShapeDecoration.color");
  const gradient$ = dart.privateName(shape_decoration, "ShapeDecoration.gradient");
  const image$ = dart.privateName(shape_decoration, "ShapeDecoration.image");
  const shadows$ = dart.privateName(shape_decoration, "ShapeDecoration.shadows");
  const shape$ = dart.privateName(shape_decoration, "ShapeDecoration.shape");
  ...
  const onChanged$ = dart.privateName(decoration, "BoxPainter.onChanged");
  ...
  const side$ = dart.privateName(rounded_rectangle_border, "RoundedRectangleBorder.side");
  const borderRadius$ = dart.privateName(rounded_rectangle_border, "RoundedRectangleBorder.borderRadius");
  ...
  const side$0 = dart.privateName(rounded_rectangle_border, "_RoundedRectangleToCircleBorder.side");
  const borderRadius$0 = dart.privateName(rounded_rectangle_border, "_RoundedRectangleToCircleBorder.borderRadius");
  const circleness$ = dart.privateName(rounded_rectangle_border, "_RoundedRectangleToCircleBorder.circleness");
  ...
  const left$ = dart.privateName(edge_insets, "EdgeInsets.left");
  const top$ = dart.privateName(edge_insets, "EdgeInsets.top");
  const right$ = dart.privateName(edge_insets, "EdgeInsets.right");
  const bottom$ = dart.privateName(edge_insets, "EdgeInsets.bottom");
  let C16;
  ...
  let C17;
  let C18;
  const start$ = dart.privateName(edge_insets, "EdgeInsetsDirectional.start");
  const top$0 = dart.privateName(edge_insets, "EdgeInsetsDirectional.top");
  const end$ = dart.privateName(edge_insets, "EdgeInsetsDirectional.end");
  const bottom$0 = dart.privateName(edge_insets, "EdgeInsetsDirectional.bottom");
  let C19;
  ...
  const _left$ = dart.privateName(edge_insets, "_MixedEdgeInsets._left");
  const _right$ = dart.privateName(edge_insets, "_MixedEdgeInsets._right");
  const _start$ = dart.privateName(edge_insets, "_MixedEdgeInsets._start");
  const _end$ = dart.privateName(edge_insets, "_MixedEdgeInsets._end");
  const _top$ = dart.privateName(edge_insets, "_MixedEdgeInsets._top");
  const _bottom$ = dart.privateName(edge_insets, "_MixedEdgeInsets._bottom");
  ...
  const topStart$ = dart.privateName(border_radius, "BorderRadiusDirectional.topStart");
  const topEnd$ = dart.privateName(border_radius, "BorderRadiusDirectional.topEnd");
  const bottomStart$ = dart.privateName(border_radius, "BorderRadiusDirectional.bottomStart");
  const bottomEnd$ = dart.privateName(border_radius, "BorderRadiusDirectional.bottomEnd");
  let C36;
  ...
  const _topLeft$ = dart.privateName(border_radius, "_MixedBorderRadius._topLeft");
  const _topRight$ = dart.privateName(border_radius, "_MixedBorderRadius._topRight");
  const _bottomLeft$ = dart.privateName(border_radius, "_MixedBorderRadius._bottomLeft");
  const _bottomRight$ = dart.privateName(border_radius, "_MixedBorderRadius._bottomRight");
  const _topStart$ = dart.privateName(border_radius, "_MixedBorderRadius._topStart");
  const _topEnd$ = dart.privateName(border_radius, "_MixedBorderRadius._topEnd");
  const _bottomStart$ = dart.privateName(border_radius, "_MixedBorderRadius._bottomStart");
  const _bottomEnd$ = dart.privateName(border_radius, "_MixedBorderRadius._bottomEnd");
  ...
  const bundle$ = dart.privateName(image_provider, "ImageConfiguration.bundle");
  const devicePixelRatio$ = dart.privateName(image_provider, "ImageConfiguration.devicePixelRatio");
  const locale$ = dart.privateName(image_provider, "ImageConfiguration.locale");
  const textDirection$ = dart.privateName(image_provider, "ImageConfiguration.textDirection");
  const size$ = dart.privateName(image_provider, "ImageConfiguration.size");
  const platform$0 = dart.privateName(image_provider, "ImageConfiguration.platform");
  let C37;
  ...
  image_provider.ImageProvider$ = dart.generic(T => {
    ...
    class ImageProvider extends core.Object {
      resolve(configuration) {
        if (!(configuration != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 275, 12, "configuration != null");
  ...
  const bundle$0 = dart.privateName(image_provider, "AssetBundleImageKey.bundle");
  const name$ = dart.privateName(image_provider, "AssetBundleImageKey.name");
  const scale$ = dart.privateName(image_provider, "AssetBundleImageKey.scale");
  ...
  (image_provider.AssetBundleImageKey.new = function(opts) {
    ...
    this[name$] = name;
    this[scale$] = scale;
    if (!(bundle != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 421, 15, "bundle != null");
    if (!(name != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 422, 15, "name != null");
    if (!(scale != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 423, 15, "scale != null");
    ;
  ...
  const providerCacheKey$ = dart.privateName(image_provider, "_SizeAwareCacheKey.providerCacheKey");
  const width$0 = dart.privateName(image_provider, "_SizeAwareCacheKey.width");
  const height$ = dart.privateName(image_provider, "_SizeAwareCacheKey.height");
  image_provider._SizeAwareCacheKey = class _SizeAwareCacheKey extends core.Object {
    ...
    _equals(other) {
      if (other == null) return false;
      if (!dart.equals(dart.runtimeType(other), this[$runtimeType])) return false;
      let typedOther = image_provider._SizeAwareCacheKey._check(other);
      return dart.equals(this.providerCacheKey, typedOther.providerCacheKey) && this.width == typedOther.width && this.height == typedOther.height;
    }
    get hashCode() {
  ...
  const imageProvider$ = dart.privateName(image_provider, "ResizeImage.imageProvider");
  const width$1 = dart.privateName(image_provider, "ResizeImage.width");
  const height$0 = dart.privateName(image_provider, "ResizeImage.height");
  image_provider.ResizeImage = class ResizeImage extends image_provider.ImageProvider$(image_provider._SizeAwareCacheKey) {
    ...
    load(key, decode) {
      ...
      let decodeResize = dart.fn((bytes, opts) => {
        ...
        if (!(cacheWidth == null && cacheHeight == null)) dart.assertFailed("ResizeImage cannot be composed with another ImageProvider that applies cacheWidth or cacheHeight.", "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 559, 9, "cacheWidth == null && cacheHeight == null");
  ...
  (image_provider.ResizeImage.new = function(imageProvider, opts) {
    ...
    if (!(width != null || height != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 532, 15, "width != null || height != null");
  ...
  const file$ = dart.privateName(image_provider, "FileImage.file");
  const scale$0 = dart.privateName(image_provider, "FileImage.scale");
  image_provider.FileImage = class FileImage extends image_provider.ImageProvider {
    ...
    [_loadAsync](key, decode) {
      return async.async(ui.Codec, (function* _loadAsync() {
        if (!dart.equals(key, this)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 647, 12, "key == this");
  ...
  (image_provider.FileImage.new = function(file, opts) {
    ...
    this[file$] = file;
    this[scale$0] = scale;
    if (!(file != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 621, 14, "file != null");
    if (!(scale != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 622, 14, "scale != null");
  ...
  const bytes$ = dart.privateName(image_provider, "MemoryImage.bytes");
  const scale$1 = dart.privateName(image_provider, "MemoryImage.scale");
  image_provider.MemoryImage = class MemoryImage extends image_provider.ImageProvider {
    ...
    [_loadAsync](key, decode) {
      if (!dart.equals(key, this)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 712, 12, "key == this");
  ...
  (image_provider.MemoryImage.new = function(bytes, opts) {
    ...
    this[bytes$] = bytes;
    this[scale$1] = scale;
    if (!(bytes != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 689, 14, "bytes != null");
    if (!(scale != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 690, 14, "scale != null");
  ...
  const assetName$ = dart.privateName(image_provider, "ExactAssetImage.assetName");
  const scale$2 = dart.privateName(image_provider, "ExactAssetImage.scale");
  const bundle$1 = dart.privateName(image_provider, "ExactAssetImage.bundle");
  const package$ = dart.privateName(image_provider, "ExactAssetImage.package");
  ...
  (image_provider.ExactAssetImage.new = function(assetName, opts) {
    ...
    if (!(assetName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 818, 15, "assetName != null");
    if (!(scale != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 819, 15, "scale != null");
  ...
  const statusCode$ = dart.privateName(image_provider, "NetworkImageLoadException.statusCode");
  const uri$ = dart.privateName(image_provider, "NetworkImageLoadException.uri");
  ...
  (image_provider.NetworkImageLoadException.new = function(opts) {
    ...
    this[uri$] = uri;
    if (!(uri != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 897, 16, "uri != null");
    if (!(statusCode != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/image_provider.dart", 898, 16, "statusCode != null");
  ...
  const image$0 = dart.privateName(image_stream, "ImageInfo.image");
  const scale$3 = dart.privateName(image_stream, "ImageInfo.scale");
  ...
  const onImage$ = dart.privateName(image_stream, "ImageStreamListener.onImage");
  const onChunk$ = dart.privateName(image_stream, "ImageStreamListener.onChunk");
  const onError$ = dart.privateName(image_stream, "ImageStreamListener.onError");
  ...
  const cumulativeBytesLoaded$ = dart.privateName(image_stream, "ImageChunkEvent.cumulativeBytesLoaded");
  const expectedTotalBytes$ = dart.privateName(image_stream, "ImageChunkEvent.expectedTotalBytes");
  ...
  shader_warm_up.DefaultShaderWarmUp = class DefaultShaderWarmUp extends shader_warm_up.ShaderWarmUp {
    ...
    warmUpOnCanvas(canvas) {
      return async.async(dart.void, (function* warmUpOnCanvas() {
        ...
        canvas.restore();
        canvas.translate(0.0, this.drawCallSpacing);
        let paragraphBuilder = (t13$4 = ui.ParagraphBuilder.new(ui.ParagraphStyle.new({textDirection: ui.TextDirection.ltr})), t13$4.pushStyle(ui.TextStyle.new({color: black})), t13$4.addText("_"), t13$4);
  ...
  const url$ = dart.privateName(_network_image_web, "NetworkImage.url");
  const scale$4 = dart.privateName(_network_image_web, "NetworkImage.scale");
  const headers$ = dart.privateName(_network_image_web, "NetworkImage.headers");
  ...
  const radians$ = dart.privateName(gradient, "GradientRotation.radians");
  gradient.GradientRotation = class GradientRotation extends gradient.GradientTransform {
    ...
    transform(bounds, opts) {
      ...
      t13 = vector_math_64.Matrix4.identity();
      t13.translate(originX, originY);
      t13.rotateZ(this.radians);
      return t13;
    }
  };
  ...
  const _resolveTransform = dart.privateName(gradient, "_resolveTransform");
  const colors$ = dart.privateName(gradient, "Gradient.colors");
  const stops$ = dart.privateName(gradient, "Gradient.stops");
  const transform$ = dart.privateName(gradient, "Gradient.transform");
  gradient.Gradient = class Gradient extends core.Object {
    ...
    [_resolveTransform](bounds, textDirection) {
      let t13, t13$;
      t13$ = (t13 = this.transform, t13 == null ? null : t13.transform(bounds, {textDirection: textDirection}));
      return t13$ == null ? null : t13$.storage;
    }
  };
  ...
  let C47;
  let C48;
  const begin$ = dart.privateName(gradient, "LinearGradient.begin");
  const end$0 = dart.privateName(gradient, "LinearGradient.end");
  const tileMode$ = dart.privateName(gradient, "LinearGradient.tileMode");
  gradient.LinearGradient = class LinearGradient extends gradient.Gradient {
    ...
    _equals(other) {
      ...
      if (this.colors != null) {
        if (!(typedOther.colors != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/gradient.dart", 509, 14, "typedOther.colors != null");
        if (!(this.colors[$length] == typedOther.colors[$length])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/gradient.dart", 510, 14, "colors.length == typedOther.colors.length");
      ...
      if (this.stops != null) {
        if (!(typedOther.stops != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/gradient.dart", 517, 14, "typedOther.stops != null");
        if (!(this.stops[$length] == typedOther.stops[$length])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/gradient.dart", 518, 14, "stops.length == typedOther.stops.length");
  ...
  let C49;
  const center$ = dart.privateName(gradient, "RadialGradient.center");
  const radius$ = dart.privateName(gradient, "RadialGradient.radius");
  const tileMode$0 = dart.privateName(gradient, "RadialGradient.tileMode");
  const focal$ = dart.privateName(gradient, "RadialGradient.focal");
  const focalRadius$ = dart.privateName(gradient, "RadialGradient.focalRadius");
  gradient.RadialGradient = class RadialGradient extends gradient.Gradient {
    ...
    static lerp(a, b, t) {
      if (!(t != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/gradient.dart", 748, 12, "t != null");
      if (a == null && b == null) return null;
      if (a == null) return b.scale(t);
      if (b == null) return a.scale(1.0 - dart.notNull(t));
      let interpolated = gradient._interpolateColorsAndStops(a.colors, a[_impliedStops](), b.colors, b[_impliedStops](), t);
    ...
    _equals(other) {
      ...
      if (this.colors != null) {
        if (!(typedOther.colors != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/gradient.dart", 789, 14, "typedOther.colors != null");
        if (!(this.colors[$length] == typedOther.colors[$length])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/gradient.dart", 790, 14, "colors.length == typedOther.colors.length");
        for (let i = 0; i < dart.notNull(this.colors[$length]); i = i + 1) {
          if (!dart.equals(this.colors[$_get](i), typedOther.colors[$_get](i))) return false;
        }
      }
      if (this.stops != null) {
        if (!(typedOther.stops != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/gradient.dart", 797, 14, "typedOther.stops != null");
        if (!(this.stops[$length] == typedOther.stops[$length])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/gradient.dart", 798, 14, "stops.length == typedOther.stops.length");
        for (let i = 0; i < dart.notNull(this.stops[$length]); i = i + 1) {
          if (this.stops[$_get](i) != typedOther.stops[$_get](i)) return false;
        }
      }
  ...
  (gradient.RadialGradient.new = function(opts) {
    ...
    if (!(center != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/gradient.dart", 619, 15, "center != null");
    if (!(radius != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/gradient.dart", 620, 15, "radius != null");
    if (!(tileMode != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/gradient.dart", 621, 15, "tileMode != null");
    if (!(focalRadius != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/gradient.dart", 622, 15, "focalRadius != null");
  ...
  const center$0 = dart.privateName(gradient, "SweepGradient.center");
  const startAngle$ = dart.privateName(gradient, "SweepGradient.startAngle");
  const endAngle$ = dart.privateName(gradient, "SweepGradient.endAngle");
  const tileMode$1 = dart.privateName(gradient, "SweepGradient.tileMode");
  gradient.SweepGradient = class SweepGradient extends gradient.Gradient {
    ...
    static lerp(a, b, t) {
      if (!(t != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/gradient.dart", 1013, 12, "t != null");
      if (a == null && b == null) return null;
      if (a == null) return b.scale(t);
      if (b == null) return a.scale(1.0 - dart.notNull(t));
      let interpolated = gradient._interpolateColorsAndStops(a.colors, a[_impliedStops](), b.colors, b[_impliedStops](), t);
    ...
    _equals(other) {
      ...
      if (this.colors != null) {
        if (!(typedOther.colors != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/gradient.dart", 1052, 14, "typedOther.colors != null");
        if (!(this.colors[$length] == typedOther.colors[$length])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/gradient.dart", 1053, 14, "colors.length == typedOther.colors.length");
        for (let i = 0; i < dart.notNull(this.colors[$length]); i = i + 1) {
          if (!dart.equals(this.colors[$_get](i), typedOther.colors[$_get](i))) return false;
        }
      }
      if (this.stops != null) {
        if (!(typedOther.stops != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/gradient.dart", 1060, 14, "typedOther.stops != null");
        if (!(this.stops[$length] == typedOther.stops[$length])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/gradient.dart", 1061, 14, "stops.length == typedOther.stops.length");
        for (let i = 0; i < dart.notNull(this.stops[$length]); i = i + 1) {
          if (this.stops[$_get](i) != typedOther.stops[$_get](i)) return false;
        }
      }
  ...
  (gradient.SweepGradient.new = function(opts) {
    ...
    if (!(center != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/gradient.dart", 911, 15, "center != null");
    if (!(startAngle != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/gradient.dart", 912, 15, "startAngle != null");
    if (!(endAngle != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/gradient.dart", 913, 15, "endAngle != null");
    if (!(tileMode != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/gradient.dart", 914, 15, "tileMode != null");
  ...
  alignment.Alignment = class Alignment extends alignment.AlignmentGeometry {
    ...
    static lerp(a, b, t) {
      if (!(t != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/alignment.dart", 337, 12, "t != null");
      if (a == null && b == null) return null;
  ...
  const start$0 = dart.privateName(alignment, "AlignmentDirectional.start");
  const y$0 = dart.privateName(alignment, "AlignmentDirectional.y");
  let C56;
  let C57;
  let C58;
  let C59;
  ...
  alignment.AlignmentDirectional = class AlignmentDirectional extends alignment.AlignmentGeometry {
    ...
    static lerp(a, b, t) {
      if (!(t != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/alignment.dart", 518, 12, "t != null");
      if (a == null && b == null) return null;
    ...
    resolve(direction) {
      if (!(direction != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/alignment.dart", 530, 12, "direction != null");
      switch (direction) {
        case C17 || CT.C17:
        {
  ...
  (alignment.AlignmentDirectional.new = function(start, y) {
    this[start$0] = start;
    this[y$0] = y;
    if (!(start != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/alignment.dart", 393, 14, "start != null");
    if (!(y != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/alignment.dart", 394, 14, "y != null");
  ...
  const _x$ = dart.privateName(alignment, "_MixedAlignment._x");
  const _start$1 = dart.privateName(alignment, "_MixedAlignment._start");
  const _y$ = dart.privateName(alignment, "_MixedAlignment._y");
  alignment._MixedAlignment = class _MixedAlignment extends alignment.AlignmentGeometry {
    ...
    resolve(direction) {
      if (!(direction != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/alignment.dart", 626, 12, "direction != null");
      switch (direction) {
        case C17 || CT.C17:
        {
  ...
  const y$1 = dart.privateName(alignment, "TextAlignVertical.y");
  let C65;
  let C66;
  let C67;
  ...
  (alignment.TextAlignVertical.new = function(opts) {
    ...
    this[y$1] = y;
    if (!(y != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/alignment.dart", 656, 15, "y != null");
    if (!(dart.notNull(y) >= -1.0 && dart.notNull(y) <= 1.0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/alignment.dart", 657, 15, "y >= -1.0 && y <= 1.0");
    ;
  ...
  const image$1 = dart.privateName(decoration_image, "DecorationImage.image");
  const colorFilter$ = dart.privateName(decoration_image, "DecorationImage.colorFilter");
  const fit$ = dart.privateName(decoration_image, "DecorationImage.fit");
  const alignment$ = dart.privateName(decoration_image, "DecorationImage.alignment");
  const centerSlice$ = dart.privateName(decoration_image, "DecorationImage.centerSlice");
  const repeat$ = dart.privateName(decoration_image, "DecorationImage.repeat");
  const matchTextDirection$ = dart.privateName(decoration_image, "DecorationImage.matchTextDirection");
      ...
      if (dart.test(this[_details$].matchTextDirection)) {
        if (!dart.test(dart.fn(() => {
          if (configuration.textDirection == null) {
            dart.throw(new assertions.FlutterError.fromParts(JSArrayOfDiagnosticsNode().of([new assertions.ErrorSummary.new("ImageDecoration.matchTextDirection can only be used when a TextDirection is available."), new assertions.ErrorDescription.new("When DecorationImagePainter.paint() was called, there was no text direction provided " + "in the ImageConfiguration object to match."), new (DiagnosticsPropertyOfDecorationImage()).new("The DecorationImage was", this[_details$], {style: diagnostics.DiagnosticsTreeStyle.errorProperty}), new (DiagnosticsPropertyOfImageConfiguration()).new("The ImageConfiguration was", configuration, {style: diagnostics.DiagnosticsTreeStyle.errorProperty})])));
          }
          return true;
  ...
  const source$ = dart.privateName(box_fit, "FittedSizes.source");
  const destination$ = dart.privateName(box_fit, "FittedSizes.destination");
  ...
  const alpha$ = dart.privateName(colors, "HSVColor.alpha");
  const hue$ = dart.privateName(colors, "HSVColor.hue");
  const saturation$ = dart.privateName(colors, "HSVColor.saturation");
  const value$ = dart.privateName(colors, "HSVColor.value");
  ...
  const alpha$0 = dart.privateName(colors, "HSLColor.alpha");
  const hue$0 = dart.privateName(colors, "HSLColor.hue");
  const saturation$0 = dart.privateName(colors, "HSLColor.saturation");
  const lightness$ = dart.privateName(colors, "HSLColor.lightness");
  colors.HSLColor = class HSLColor extends core.Object {
    ...
    static lerp(a, b, t) {
      if (!(t != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/colors.dart", 387, 12, "t != null");
      if (a == null && b == null) return null;
      if (a == null) return b[_scaleAlpha](t);
      if (b == null) return a[_scaleAlpha](1.0 - dart.notNull(t));
  ...
  (colors.HSLColor.fromAHSL = function(alpha, hue, saturation, lightness) {
    ...
    if (!(alpha != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/colors.dart", 263, 14, "alpha != null");
    if (!(hue != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/colors.dart", 264, 14, "hue != null");
    if (!(saturation != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/colors.dart", 265, 14, "saturation != null");
    if (!(lightness != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/colors.dart", 266, 14, "lightness != null");
    if (!(dart.notNull(alpha) >= 0.0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/colors.dart", 267, 14, "alpha >= 0.0");
    if (!(dart.notNull(alpha) <= 1.0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/colors.dart", 268, 14, "alpha <= 1.0");
    if (!(dart.notNull(hue) >= 0.0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/colors.dart", 269, 14, "hue >= 0.0");
    if (!(dart.notNull(hue) <= 360.0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/colors.dart", 270, 14, "hue <= 360.0");
    if (!(dart.notNull(saturation) >= 0.0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/colors.dart", 271, 14, "saturation >= 0.0");
    if (!(dart.notNull(saturation) <= 1.0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/colors.dart", 272, 14, "saturation <= 1.0");
    if (!(dart.notNull(lightness) >= 0.0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/colors.dart", 273, 14, "lightness >= 0.0");
    if (!(dart.notNull(lightness) <= 1.0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/colors.dart", 274, 14, "lightness <= 1.0");
    ;
  ...
  const _swatch$ = dart.privateName(colors, "ColorSwatch._swatch");
  ...
  (colors.ColorProperty.new = function(name, value, opts) {
    ...
    if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/colors.dart", 476, 15, "showName != null");
    if (!(style != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/colors.dart", 477, 15, "style != null");
    if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/colors.dart", 478, 15, "level != null");
  ...
  let C87;
  const spreadRadius$ = dart.privateName(box_shadow, "BoxShadow.spreadRadius");
  ...
  const color$1 = dart.privateName(box_decoration, "BoxDecoration.color");
  const image$2 = dart.privateName(box_decoration, "BoxDecoration.image");
  const border$ = dart.privateName(box_decoration, "BoxDecoration.border");
  const borderRadius$1 = dart.privateName(box_decoration, "BoxDecoration.borderRadius");
  const boxShadow$ = dart.privateName(box_decoration, "BoxDecoration.boxShadow");
  const gradient$0 = dart.privateName(box_decoration, "BoxDecoration.gradient");
  const backgroundBlendMode$ = dart.privateName(box_decoration, "BoxDecoration.backgroundBlendMode");
  const shape$0 = dart.privateName(box_decoration, "BoxDecoration.shape");
  ...
  box_border.Border = class Border extends box_border.BoxBorder {
    ...
    static merge(a, b) {
      if (!(a != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 349, 12, "a != null");
      if (!(b != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 350, 12, "b != null");
      if (!dart.test(borders$.BorderSide.canMerge(a.top, b.top))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 351, 12, "BorderSide.canMerge(a.top, b.top)");
      if (!dart.test(borders$.BorderSide.canMerge(a.right, b.right))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 352, 12, "BorderSide.canMerge(a.right, b.right)");
      if (!dart.test(borders$.BorderSide.canMerge(a.bottom, b.bottom))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 353, 12, "BorderSide.canMerge(a.bottom, b.bottom)");
      if (!dart.test(borders$.BorderSide.canMerge(a.left, b.left))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 354, 12, "BorderSide.canMerge(a.left, b.left)");
    ...
    static lerp(a, b, t) {
      if (!(t != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 448, 12, "t != null");
      if (a == null && b == null) return null;
      if (a == null) return b.scale(t);
      if (b == null) return a.scale(1.0 - dart.notNull(t));
    ...
    paint(canvas, rect, opts) {
        ...
        switch (this.top.style) {
          ...
          case C13 || CT.C13:
          {
            switch (shape) {
              case C8 || CT.C8:
              {
                if (!(borderRadius == null)) dart.assertFailed("A borderRadius can only be given for rectangular boxes.", "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 497, 22, "borderRadius == null");
      ...
      if (!(borderRadius == null)) dart.assertFailed("A borderRadius can only be given for uniform borders.", "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 512, 12, "borderRadius == null");
      if (!dart.equals(shape, box_border.BoxShape.rectangle)) dart.assertFailed("A border can only be drawn as a circle if it is uniform.", "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 513, 12, "shape == BoxShape.rectangle");
  ...
  const top$2 = dart.privateName(box_border, "BorderDirectional.top");
  const start$1 = dart.privateName(box_border, "BorderDirectional.start");
  const end$1 = dart.privateName(box_border, "BorderDirectional.end");
  const bottom$2 = dart.privateName(box_border, "BorderDirectional.bottom");
  box_border.BorderDirectional = class BorderDirectional extends box_border.BoxBorder {
    ...
    static merge(a, b) {
      if (!(a != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 595, 12, "a != null");
      if (!(b != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 596, 12, "b != null");
      if (!dart.test(borders$.BorderSide.canMerge(a.top, b.top))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 597, 12, "BorderSide.canMerge(a.top, b.top)");
      if (!dart.test(borders$.BorderSide.canMerge(a.start, b.start))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 598, 12, "BorderSide.canMerge(a.start, b.start)");
      if (!dart.test(borders$.BorderSide.canMerge(a.end, b.end))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 599, 12, "BorderSide.canMerge(a.end, b.end)");
      if (!dart.test(borders$.BorderSide.canMerge(a.bottom, b.bottom))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 600, 12, "BorderSide.canMerge(a.bottom, b.bottom)");
    ...
    add(other, opts) {
      ...
      if (box_border.Border.is(other)) {
        ...
        if (!dart.equals(this.start, borders$.BorderSide.none) || !dart.equals(this.end, borders$.BorderSide.none)) {
          ...
          if (!dart.equals(typedOther.left, borders$.BorderSide.none)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 685, 16, "typedOther.left == BorderSide.none");
          if (!dart.equals(typedOther.right, borders$.BorderSide.none)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 686, 16, "typedOther.right == BorderSide.none");
        ...
        if (!dart.equals(this.start, borders$.BorderSide.none)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 694, 14, "start == BorderSide.none");
        if (!dart.equals(this.end, borders$.BorderSide.none)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 695, 14, "end == BorderSide.none");
    ...
    static lerp(a, b, t) {
      if (!(t != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 737, 12, "t != null");
      if (a == null && b == null) return null;
      if (a == null) return b.scale(t);
      if (b == null) return a.scale(1.0 - dart.notNull(t));
    ...
    paint(canvas, rect, opts) {
        ...
        switch (this.top.style) {
          ...
          case C13 || CT.C13:
          {
            switch (shape) {
              case C8 || CT.C8:
              {
                if (!(borderRadius == null)) dart.assertFailed("A borderRadius can only be given for rectangular boxes.", "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 789, 22, "borderRadius == null");
                box_border.BoxBorder._paintUniformBorderWithCircle(canvas, rect, this.top);
                break;
              }
              case C10 || CT.C10:
      ...
      if (!(borderRadius == null)) dart.assertFailed("A borderRadius can only be given for uniform borders.", "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 804, 12, "borderRadius == null");
      if (!dart.equals(shape, box_border.BoxShape.rectangle)) dart.assertFailed("A border can only be drawn as a circle if it is uniform.", "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 805, 12, "shape == BoxShape.rectangle");
      let left = null;
      let right = null;
      if (!(textDirection != null)) dart.assertFailed("Non-uniform BorderDirectional objects require a TextDirection when painting.", "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 808, 12, "textDirection != null");
      switch (textDirection) {
        case C17 || CT.C17:
        {
          left = this.end;
  ...
  (box_border.BorderDirectional.new = function(opts) {
    ...
    if (!(top != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 582, 15, "top != null");
    if (!(start != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 583, 15, "start != null");
    if (!(end != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 584, 15, "end != null");
    if (!(bottom != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/box_border.dart", 585, 15, "bottom != null");
  ...
  const inherit$ = dart.privateName(text_style, "TextStyle.inherit");
  const color$2 = dart.privateName(text_style, "TextStyle.color");
  const backgroundColor$ = dart.privateName(text_style, "TextStyle.backgroundColor");
  const fontFamily$ = dart.privateName(text_style, "TextStyle.fontFamily");
  const _fontFamilyFallback$ = dart.privateName(text_style, "TextStyle._fontFamilyFallback");
  const _package$ = dart.privateName(text_style, "TextStyle._package");
  const fontSize$ = dart.privateName(text_style, "TextStyle.fontSize");
  const fontWeight$ = dart.privateName(text_style, "TextStyle.fontWeight");
  const fontStyle$ = dart.privateName(text_style, "TextStyle.fontStyle");
  const letterSpacing$ = dart.privateName(text_style, "TextStyle.letterSpacing");
  const wordSpacing$ = dart.privateName(text_style, "TextStyle.wordSpacing");
  const textBaseline$ = dart.privateName(text_style, "TextStyle.textBaseline");
  const height$1 = dart.privateName(text_style, "TextStyle.height");
  const locale$0 = dart.privateName(text_style, "TextStyle.locale");
  const foreground$ = dart.privateName(text_style, "TextStyle.foreground");
  const background$ = dart.privateName(text_style, "TextStyle.background");
  const decoration$ = dart.privateName(text_style, "TextStyle.decoration");
  const decorationColor$ = dart.privateName(text_style, "TextStyle.decorationColor");
  const decorationStyle$ = dart.privateName(text_style, "TextStyle.decorationStyle");
  const decorationThickness$ = dart.privateName(text_style, "TextStyle.decorationThickness");
  const debugLabel$ = dart.privateName(text_style, "TextStyle.debugLabel");
  const shadows$0 = dart.privateName(text_style, "TextStyle.shadows");
  const fontFeatures$ = dart.privateName(text_style, "TextStyle.fontFeatures");
  text_style.TextStyle = class TextStyle extends diagnostics.Diagnosticable {
    ...
    getParagraphStyle(opts) {
      ...
      if (!(textScaleFactor != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 1078, 12, "textScaleFactor != null");
      if (!(maxLines == null || dart.notNull(maxLines) > 0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 1079, 12, "maxLines == null || maxLines > 0");
    ...
    debugFillProperties(properties, opts) {
      ...
      if (this.decoration != null || this.decorationColor != null || this.decorationStyle != null || this.decorationThickness != null) {
        ...
        if (!dart.test(decorationDescription[$isNotEmpty])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 1252, 14, "decorationDescription.isNotEmpty");
  ...
  const fontFamily$0 = dart.privateName(strut_style, "StrutStyle.fontFamily");
  const _fontFamilyFallback$1 = dart.privateName(strut_style, "StrutStyle._fontFamilyFallback");
  const _package$1 = dart.privateName(strut_style, "StrutStyle._package");
  const fontSize$0 = dart.privateName(strut_style, "StrutStyle.fontSize");
  const height$2 = dart.privateName(strut_style, "StrutStyle.height");
  const fontWeight$0 = dart.privateName(strut_style, "StrutStyle.fontWeight");
  const fontStyle$0 = dart.privateName(strut_style, "StrutStyle.fontStyle");
  const leading$ = dart.privateName(strut_style, "StrutStyle.leading");
  const forceStrutHeight$ = dart.privateName(strut_style, "StrutStyle.forceStrutHeight");
  const debugLabel$0 = dart.privateName(strut_style, "StrutStyle.debugLabel");
  let C89;
  ...
  (strut_style.StrutStyle.new = function(opts) {
    ...
    if (!(fontSize == null || dart.notNull(fontSize) > 0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/strut_style.dart", 310, 15, "fontSize == null || fontSize > 0");
    if (!(leading == null || dart.notNull(leading) >= 0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/strut_style.dart", 311, 15, "leading == null || leading >= 0");
    if (!($package == null || $package != null && (fontFamily != null || fontFamilyFallback != null))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/strut_style.dart", 312, 15, "package == null || (package != null && (fontFamily != null || fontFamilyFallback != null))");
  ...
  (strut_style.StrutStyle.fromTextStyle = function(textStyle, opts) {
    ...
    this[leading$] = leading;
    this[forceStrutHeight$] = forceStrutHeight;
    if (!(textStyle != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/strut_style.dart", 345, 15, "textStyle != null");
    if (!(fontSize == null || dart.notNull(fontSize) > 0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/strut_style.dart", 346, 15, "fontSize == null || fontSize > 0");
    if (!(leading == null || dart.notNull(leading) >= 0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/strut_style.dart", 347, 15, "leading == null || leading >= 0");
    if (!($package == null || $package != null && (fontFamily != null || fontFamilyFallback != null))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/strut_style.dart", 348, 15, "package == null || (package != null && (fontFamily != null || fontFamilyFallback != null))");
    ...
    this[height$2] = (t17$ = height, t17$ == null ? textStyle.height : t17$);
  ...
  const text$ = dart.privateName(inline_span, "InlineSpanSemanticsInformation.text");
  const semanticsLabel$ = dart.privateName(inline_span, "InlineSpanSemanticsInformation.semanticsLabel");
  const recognizer$ = dart.privateName(inline_span, "InlineSpanSemanticsInformation.recognizer");
  const isPlaceholder$ = dart.privateName(inline_span, "InlineSpanSemanticsInformation.isPlaceholder");
  const requiresOwnNode = dart.privateName(inline_span, "InlineSpanSemanticsInformation.requiresOwnNode");
  let C90;
  ...
  const style$0 = dart.privateName(inline_span, "InlineSpan.style");
  inline_span.InlineSpan = class InlineSpan extends diagnostics.DiagnosticableTree {
    ...
    getSpanForPosition(position) {
      if (!dart.test(this.debugAssertIsValid())) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/inline_span.dart", 217, 12, "debugAssertIsValid()");
  ...
  let C91;
  const text$0 = dart.privateName(text_span, "TextSpan.text");
  const children$ = dart.privateName(text_span, "TextSpan.children");
  const recognizer$0 = dart.privateName(text_span, "TextSpan.recognizer");
  const semanticsLabel$0 = dart.privateName(text_span, "TextSpan.semanticsLabel");
  ...
  const size$0 = dart.privateName(text_painter, "PlaceholderDimensions.size");
  const alignment$0 = dart.privateName(text_painter, "PlaceholderDimensions.alignment");
  const baselineOffset$ = dart.privateName(text_painter, "PlaceholderDimensions.baselineOffset");
  const baseline$ = dart.privateName(text_painter, "PlaceholderDimensions.baseline");
  ...
  const offset$ = dart.privateName(text_painter, "_CaretMetrics.offset");
  const fullHeight$ = dart.privateName(text_painter, "_CaretMetrics.fullHeight");
  ...
  text_painter.TextPainter = class TextPainter extends core.Object {
    ...
    set ellipsis(value) {
      if (!(value == null || value[$isNotEmpty])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 273, 12, "value == null || value.isNotEmpty");
    ...
    set maxLines(value) {
      if (!(value == null || dart.notNull(value) > 0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 301, 12, "value == null || value > 0");
    ...
    set textWidthBasis(value) {
      if (!(value != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 335, 12, "value != null");
    ...
    setPlaceholderDimensions(value) {
      ...
      }, VoidToint())() == value[$length])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 376, 12, "() {\n      int placeholderCount = 0;\n      text.visitChildren((InlineSpan span) {\n        if (span is PlaceholderSpan) {\n          placeholderCount += 1;\n        }\n        return true;\n      });\n      return placeholderCount;\n    }() == value.length");
    ...
    [_createParagraphStyle](defaultTextDirection) {
      ...
      if (!(this.textAlign != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 394, 12, "textAlign != null");
      if (!(this.textDirection != null || defaultTextDirection != null)) dart.assertFailed("TextPainter.textDirection must be set to a non-null value before using the TextPainter.", "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 395, 12, "textDirection != null || defaultTextDirection != null");
      ...
      return t17$ == null ? ui.ParagraphStyle.new({textAlign: this.textAlign, textDirection: (t18$ = this.textDirection, t18$ == null ? defaultTextDirection : t18$), maxLines: this.maxLines, ellipsis: this.ellipsis, locale: this.locale}) : t17$;
    }
    ...
    get minIntrinsicWidth() {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 455, 12, "!_needsLayout");
      return this[_applyFloatingPointHack](this[_paragraph].minIntrinsicWidth);
    }
    get maxIntrinsicWidth() {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 463, 12, "!_needsLayout");
      return this[_applyFloatingPointHack](this[_paragraph].maxIntrinsicWidth);
    }
    get width() {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 471, 12, "!_needsLayout");
    ...
    get height() {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 481, 12, "!_needsLayout");
      return this[_applyFloatingPointHack](this[_paragraph].height);
    }
    get size() {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 489, 12, "!_needsLayout");
      return new ui.Size.new(this.width, this.height);
    }
    computeDistanceToActualBaseline(baseline) {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 498, 12, "!_needsLayout");
      if (!(baseline != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 499, 12, "baseline != null");
      switch (baseline) {
        case C97 || CT.C97:
        {
    ...
    get didExceedMaxLines() {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 521, 12, "!_needsLayout");
    ...
    layout(opts) {
      ...
      if (!(this.text != null)) dart.assertFailed("TextPainter.text must be set to a non-null value before using the TextPainter.", "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 537, 12, "text != null");
      if (!(this.textDirection != null)) dart.assertFailed("TextPainter.textDirection must be set to a non-null value before using the TextPainter.", "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 538, 12, "textDirection != null");
    ...
    paint(canvas, offset) {
      if (!dart.test(dart.fn(() => {
        ...
        return true;
      }, VoidTobool())())) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 573, 12, "() {\n      if (_needsLayout) {\n        throw FlutterError(\n          'TextPainter.paint called when text geometry was not yet calculated.\\n'\n          'Please call layout() before paint() to position the text before painting it.'\n        );\n      }\n      return true;\n    }()");
    ...
    get [_emptyOffset]() {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 706, 12, "!_needsLayout");
      if (!(this.textAlign != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 707, 12, "textAlign != null");
      switch (this.textAlign) {
        ...
        case C95 || CT.C95:
        {
          if (!(this.textDirection != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 717, 16, "textDirection != null");
        ...
        case C103 || CT.C103:
        {
          if (!(this.textDirection != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 726, 16, "textDirection != null");
          switch (this.textDirection) {
            case C17 || CT.C17:
            {
              return ui.Offset.zero;
    ...
    [_computeCaretMetrics](position, caretPrototype) {
      let t17, t17$;
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 768, 12, "!_needsLayout");
      if (dart.equals(position, this[_previousCaretPosition]) && dart.equals(caretPrototype, this[_previousCaretPrototype])) return;
      let offset = position.offset;
      if (!(position.affinity != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 772, 12, "position.affinity != null");
      let rect = null;
    ...
    getBoxesForSelection(selection) {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 800, 12, "!_needsLayout");
      return this[_paragraph].getBoxesForRange(selection.start, selection.end);
    }
    getPositionForOffset(offset) {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 806, 12, "!_needsLayout");
      return this[_paragraph].getPositionForOffset(offset);
    }
    getWordBoundary(position) {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 818, 12, "!_needsLayout");
      return this[_paragraph].getWordBoundary(position);
    }
    getLineBoundary(position) {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 831, 12, "!_needsLayout");
      return this[_paragraph].getLineBoundary(position);
    }
    computeLineMetrics() {
      if (!!dart.test(this[_needsLayout])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_painter.dart", 851, 12, "!_needsLayout");
  ...
  let C106;
  const alignment$1 = dart.privateName(placeholder_span, "PlaceholderSpan.alignment");
  const baseline$0 = dart.privateName(placeholder_span, "PlaceholderSpan.baseline");
  ...
  const lightColor$ = dart.privateName(flutter_logo, "FlutterLogoDecoration.lightColor");
  const darkColor$ = dart.privateName(flutter_logo, "FlutterLogoDecoration.darkColor");
  const textColor$ = dart.privateName(flutter_logo, "FlutterLogoDecoration.textColor");
  const style$1 = dart.privateName(flutter_logo, "FlutterLogoDecoration.style");
  const margin$ = dart.privateName(flutter_logo, "FlutterLogoDecoration.margin");
  const _position$ = dart.privateName(flutter_logo, "FlutterLogoDecoration._position");
  const _opacity$ = dart.privateName(flutter_logo, "FlutterLogoDecoration._opacity");
  ...
  flutter_logo._FlutterLogoPainter = class _FlutterLogoPainter extends decoration.BoxPainter {
    ...
    paint(canvas, offset, configuration) {
      ...
      if (dart.notNull(this[_config$][_opacity]) < 1.0) {
        canvas.saveLayer(offset['&'](canvasSize), (t17 = new ui.Paint.new(), t17.colorFilter = new _engine.EngineColorFilter.mode((C151 || CT.C151).withOpacity(this[_config$][_opacity]), ui.BlendMode.modulate), t17));
      }
  ...
  const side$2 = dart.privateName(stadium_border, "StadiumBorder.side");
  ...
  const side$3 = dart.privateName(stadium_border, "_StadiumToCircleBorder.side");
  const circleness$0 = dart.privateName(stadium_border, "_StadiumToCircleBorder.circleness");
  ...
  const side$4 = dart.privateName(stadium_border, "_StadiumToRoundedRectangleBorder.side");
  const borderRadius$2 = dart.privateName(stadium_border, "_StadiumToRoundedRectangleBorder.borderRadius");
  const rectness$ = dart.privateName(stadium_border, "_StadiumToRoundedRectangleBorder.rectness");
  ...
  const borderRadius$3 = dart.privateName(continuous_rectangle_border, "ContinuousRectangleBorder.borderRadius");
  const side$5 = dart.privateName(continuous_rectangle_border, "ContinuousRectangleBorder.side");
  ...
  matrix_utils.MatrixUtils = class MatrixUtils extends core.Object {
    ...
    static inverseTransformRect(transform, rect) {
      let t17;
      if (!(rect != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/matrix_utils.dart", 432, 12, "rect != null");
    ...
    static createCylindricalProjectionTransform(opts) {
      ...
      if (!(radius != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/matrix_utils.dart", 481, 12, "radius != null");
      if (!(angle != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/matrix_utils.dart", 482, 12, "angle != null");
      if (!(dart.notNull(perspective) >= 0 && dart.notNull(perspective) <= 1.0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/matrix_utils.dart", 483, 12, "perspective >= 0 && perspective <= 1.0");
      if (!(orientation != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/matrix_utils.dart", 484, 12, "orientation != null");
  ...
  (matrix_utils.TransformProperty.new = function(name, value, opts) {
    ...
    let defaultValue = opts && 'defaultValue' in opts ? opts.defaultValue : C84 || CT.C84;
    let level = opts && 'level' in opts ? opts.level : C86 || CT.C86;
    if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/matrix_utils.dart", 554, 15, "showName != null");
    if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/matrix_utils.dart", 555, 15, "level != null");
  ...
  const side$6 = dart.privateName(beveled_rectangle_border, "BeveledRectangleBorder.side");
  const borderRadius$4 = dart.privateName(beveled_rectangle_border, "BeveledRectangleBorder.borderRadius");
  ...
  const assetName$0 = dart.privateName(image_resolution, "AssetImage.assetName");
  const bundle$2 = dart.privateName(image_resolution, "AssetImage.bundle");
  const package$0 = dart.privateName(image_resolution, "AssetImage.package");
  ...
  const host$ = dart.privateName(notched_shapes, "AutomaticNotchedShape.host");
  const guest$ = dart.privateName(notched_shapes, "AutomaticNotchedShape.guest");
