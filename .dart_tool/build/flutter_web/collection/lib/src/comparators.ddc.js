define(['dart_sdk'], function(dart_sdk) {
  ...
  const _elementEquality$ = dart.privateName(equality, "IterableEquality._elementEquality");
  ...
  const _elementEquality$0 = dart.privateName(equality, "ListEquality._elementEquality");
  ...
  const _elementEquality$1 = dart.privateName(equality, "_UnorderedEquality._elementEquality");
  ...
  const _keyEquality$ = dart.privateName(equality, "MapEquality._keyEquality");
  const _valueEquality$ = dart.privateName(equality, "MapEquality._valueEquality");
  ...
  const _equalities$ = dart.privateName(equality, "MultiEquality._equalities");
  ...
  const _base$ = dart.privateName(equality, "DeepCollectionEquality._base");
  const _unordered$ = dart.privateName(equality, "DeepCollectionEquality._unordered");
